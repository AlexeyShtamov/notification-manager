...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleCustomAuthenticationEntryPoint(CustomAuthenticationEntryPoint e){
        return generateResponse(HttpStatus.UNAUTHORIZED, "Необходимо аутентификация в сервисе", e.getMessage());
    }
